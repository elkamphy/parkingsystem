...
public class DBConstants {
    ...
    public static final String GET_TICKET_COUNT = "select count(t.PARKING_NUMBER) from ticket t,parking p where p.parking_number = t.parking_number and t.VEHICLE_REG_NUMBER=? ";
}
